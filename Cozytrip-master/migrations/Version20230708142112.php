 ...
 */
final class Version20230708142112 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE herbergement_categorie (herbergement_id INT NOT NULL, categorie_id INT NOT NULL, INDEX IDX_E135160FD6EA2CFB (herbergement_id), INDEX IDX_E135160FBCF5E72D (categorie_id), PRIMARY KEY(herbergement_id, categorie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
