...
class Categorie extends \App\Entity\Categorie implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'Photocategorie' => [parent::class, 'Photocategorie', null],
        "\0".parent::class."\0".'herbergements' => [parent::class, 'herbergements', null],
        "\0".parent::class."\0".'id' => [parent::class, 'id', null],
        "\0".parent::class."\0".'nom' => [parent::class, 'nom', null],
        "\0".parent::class."\0".'slug' => [parent::class, 'slug', null],
        'Photocategorie' => [parent::class, 'Photocategorie', null],
        'herbergements' => [parent::class, 'herbergements', null],
