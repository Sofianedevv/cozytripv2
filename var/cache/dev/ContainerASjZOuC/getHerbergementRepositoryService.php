 ...
 */
class getHerbergementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HerbergementRepository' shared autowired service.
     *
     * @return \App\Repository\HerbergementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HerbergementRepository.php';

        return $container->privates['App\\Repository\\HerbergementRepository'] = new \App\Repository\HerbergementRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
